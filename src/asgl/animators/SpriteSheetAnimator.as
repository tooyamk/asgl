package asgl.animators {
	...
	public class SpriteSheetAnimator extends BaseAnimator {
		...
		asgl_protected var _region:TextureRegion;
		...
		public function get region():TextureRegion {
			return _region;
		}
		public function set region(value:TextureRegion):void {
			_region = value;
		}
		protected override function _update(lerp:Boolean):void {
			...
			if (_region != null) {
				var region:TextureRegion = asset.textureRegion;
				_region.x = region.x;
				_region.y = region.y;
				_region.width = region.width;
				_region.height = region.height;
				_region.rotate = region.rotate;
			}
