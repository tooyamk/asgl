package asgl.shaders.asm.agal.compiler {
	...
	public class AGALSamplerFlag {
		...
		private static function _createFilter():Object {
			...
			map[Context3DTextureFilter.ANISOTROPIC2X] = 2;
			map[Context3DTextureFilter.ANISOTROPIC4X] = 3;
			map[Context3DTextureFilter.ANISOTROPIC8X] = 4;
			map[Context3DTextureFilter.ANISOTROPIC16X] = 5;
		...
		private static function _createWrap():Object {
			...
			map[Context3DWrapMode.CLAMP_U_REPEAT_V] = 2;
			map[Context3DWrapMode.REPEAT_U_CLAMP_V] = 3;
