package asgl.renderables {
	...
	public class BaseRenderable {
		...
		asgl_protected var _scissorRectangle:Rectangle;
		...
		asgl_protected function _setObject3D(value:Object3D):void {
			_object3D = value;
		}
		...
		public function setTextureRegion(name:String, region:TextureRegion):void {
			if (region == null) {
