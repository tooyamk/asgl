package asgl.renderers {
	...
	public class PriorityFillRenderContext extends BaseRenderContext {
		...
		public override function render(device:Device3D, camera:Camera3D, root:Object3D, renderTargets:Vector.<AbstractTextureData>=null, material:Material=null):void {
			...
			if (renderTargets == null) {
				...
				device.setRenderToTargets(renderTargets);
			}
