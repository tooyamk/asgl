				...
				if (numNotPassElements > 0) {
					...
					for (var i:int = 0; i < numNotPassElements; i++) {
						...
						if (notPassElement.valueMappingType == MeshElementValueMappingType.SELF_TRIANGLE_INDEX ||
							notPassElement.valueMappingType == MeshElementValueMappingType.EACH_TRIANGLE) {
							...
							var isEachIndex:Boolean = notPassElement.valueMappingType == MeshElementValueMappingType.EACH_TRIANGLE;
