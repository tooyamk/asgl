package asgl.system {
	...
	public class IndexBufferManager {
		...
		public function createIndexBufferData(numIndices:int, bufferUsage:String=Context3DBufferUsage.STATIC_DRAW):IndexBufferData {
			var data:IndexBufferData = new IndexBufferData(_device, numIndices, bufferUsage);
