package asgl.system {
	...
	public class ProgramConstantsManager {
		private var _vertexConstantsMax:int;
		private var _fragmentConstantsMax:int;
		...
		asgl_protected function _recovery():void {
			...
			for (var i:int = 0; i < _vertexConstantsMax; i++) {
			...
			oldCount = 0;
			oldNum = 0;
			for (i = 0; i < _fragmentConstantsMax; i++) {
