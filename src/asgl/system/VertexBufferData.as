package asgl.system {
	...
	public class VertexBufferData extends DeviceData {
		...
		public function VertexBufferData(device:Device3D, numVertices:int, data32PerVertex:int, bufferUsage:String) {
			super(device);
		...
		protected function _constructor():void {
			...
			if (context != null) {
				if (context.driverInfo == Device3D.DISPOSED) {
					...
					_buffer = _device._context3D.createVertexBuffer(_numVertices, _data32PerVertex, _bufferUsage);
				}
			}
		}
