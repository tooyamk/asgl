package asgl.system {
	...
	public class TextureManager {
		...
		public function createVideoTextureData():VideoTextureData {
			var data:VideoTextureData = new VideoTextureData(_device);
			_textureMap[data._instanceID] = data;
		...
		public function deactiveUnoccupiedTextures():void {
			if (_numOccupied > 0) {
				var i:int;
				var info:TextureInfo;
